...
const Index: NextPage<Props> = ({}) => {
  ...
  return (
    <div className='h-screen bg-gradient-to-tr to-indigo-500 from-teal-500 grid place-content-center'>
      <form className='w-[400px] bg-white rounded-md overflow-hidden shadow-md py-8 px-6'>
